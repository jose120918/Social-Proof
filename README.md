...
- Sanitización del correo: la plantilla HTML se limpia permitiendo tablas, estilos inline e imágenes; si la salida quedara vacía se usa un fallback de texto para evitar errores de “Message body empty”.
